...
const CONTRACT_ADDRESS = "0x55066f99572fa2a80086d0ee5c1181d095135eff"; 
...
async function connectToMetamask() {
    ...
    return (
        <Container style={{ padding:"", border:"1px solid grey" }}>
            ...
            <Row>
                ...
                <Col xs={ 8 } style={{ "paddingLeft":"0px" }}>
                    <div style={{ "backgroundColor":"#DCDCDC", "height":"100%" }}>
                        ...
                        <div className="MessageBox" style={{ height:"350px", overflowY:"auto" }}>
                           { Messages }
                        </div>
